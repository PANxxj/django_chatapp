# Generated by Django 4.2.1 on 2023-08-30 04:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Waiting', 'Waiting'), ('Active', 'Active'), ('Closed', 'Closed')], max_length=255, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
